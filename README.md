...
Una API RESTful moderna y asíncrona construida con **FastAPI** que actúa como intermediario inteligente entre tus
usuarios
...
La API implementa un manejador global de excepciones (main.py) que transforma errores de Python en respuestas HTTP JSON
estandarizadas:
